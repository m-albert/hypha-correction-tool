...
- The **Samples** tab shows an always-visible, compact sample list with a single
  scrollbar. Selecting a sample saves the current correction before changing images.
